...
export const formations: Formation[] = [
    // 1. Les Premiers secours Niveau 1
    {
        ...
        icon: "🚑",
        image: asset("PLS.png"),
        title: "Les Premiers secours Niveau 1",
    ...
    // 2. Les Premiers secours Niveau 2
    {
        id: "premiers-secours-niveau-2",
        reference: "#0002",
        icon: "🚑",
        image: asset("PS2.jpeg"),
        title: "Les Premiers secours Niveau 2 (avancé)",
    ...
    // 4. Lutte contre les incendies
    {
        ...
        reference: "#0004",
        icon: "🔥",
        image: asset("INC1.jpg"),
        title: "Lutte contre les incendies Niveau 1",
    ...
    // 5. Lutte contre les incendies Niveau 2
    {
        id: "lutte-incendies-niveau-2",
        reference: "#0005",
        icon: "🔥",
        image: asset("inc2.jpeg"),
        title: "Lutte contre les incendies Niveau 2",
        ...
        prerequisites: "Formation lutte contre les incendies Niveau 1 ou équivalent",
        certification: "Attestation de formation à la lutte contre les incendies Niveau 2",
        targetAudience: [
    ...
    // 9. Plan d'Opérations Interne (POI)
    {
        ...
        icon: "📋",
        image: asset("POI.jpg"),
        title: "Plan d'Opérations Interne\n(POI)",
    ...
    // 10. Prévention des risques liés aux activités physiques
    {
        ...
        reference: "#0010",
        icon: "🏋️‍♂️",
        image: asset("prap-ibc.jpg"),
        title: "Prévention des risques liés aux activités physiques\n(levage et manutention)",
    ...
    // 12. Stockage et manipulation des produits chimiques
    {
        ...
        reference: "#0012",
        icon: "⚗️",
        image: asset("produits-chimiques.jpg"),
    ...
    // 14. Identification et évaluation des dangers
    {
        ...
        reference: "#0014",
        icon: "⚠️",
        image: asset("Identification et évaluation des dangers.webp"),
    ...
    // 15. Travail dans les espaces clos (confinés)
    {
        ...
        reference: "#0015",
        icon: "🔒",
        image: asset("espaces-confines.jpg"),
    ...
    // 16. Sécurité au chantier
    {
        ...
        reference: "#0016",
        icon: "🏗️",
        image: asset("Sécurité chantier.jpeg"),
    ...
    // 19. Lutte contre les incendies Recyclage
    {
        ...
        reference: "#0019",
        icon: "",
        image: asset("Inc Recyclage.jpeg"),
    ...
    // 21. La sécurité au milieu de travail
    {
        ...
        reference: "#0021",
        icon: "",
        image: asset("Sécu milieu de travail.jpg"),
